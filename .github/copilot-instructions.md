...
> **Before doing anything beyond a trivial answer, read [`INSTRUCTIONS.md`](../INSTRUCTIONS.md) at the repo root.** It is the canonical operating guide for this repo: wirings between skills/agents/scripts, file contracts, validators, standard workflows, and the pre-PR checklist. If anything below conflicts with `INSTRUCTIONS.md`, that file wins.
